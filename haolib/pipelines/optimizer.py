"""Pipeline optimizer for storage operations.

Optimizers analyze pipelines and determine how to execute them most efficiently.
They can optimize pipelines to execute on storage side (SQL, aggregation pipelines, etc.)
...
from haolib.pipelines.base import Operation
...
class PipelineOptimizer(Protocol):
    ...
    def analyze(self, pipeline: Operation) -> PipelineAnalysis:
    ...
    def optimize(self, pipeline: Operation) -> Operation:
